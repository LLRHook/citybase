...
export const ACTION_DEFS = {
  actions: [
    ...
    { id: 'review',   label: 'REVIEW PR',  key: 'P', color: 'amber',   icon: '◉', desc: 'Inspect open PR' },
  ...
  production: [
    ...
    { id: 'commission-pr', label: 'COMMISSION PR', key: 'M', color: 'magenta', icon: '◆', desc: 'Auto-draft PR' },
  ...
  upgrades: [
    ...
    { id: 'turret',  label: 'CI TURRET',     key: '3', color: 'amber',   icon: '◆', desc: 'auto-block bad PRs', cost: '1000 XP' },
