...
// Surface for the approval requests an adapter raises before applying file
// changes. Per Phase 3 slice 6 the manager pauses on requestApproval; this
// modal is what releases that promise via the renderer-side approve/reject.
